...
}
{
  ...
  return (
    <div
      className={`fixed left-0 top-0 flex h-full w-full items-center justify-center bg-black bg-opacity-50 p-5`}
    >
          ...
          <div className="my-10 max-w-[1000px] mx-auto">
            <div className="mb-4">
              ...
              <p className="text-gray-600">
                jq is a lightweight and flexible JSON processor. Use it to
                manipulate and transform JSON data.
              </p>
            </div>
            ...
            <div className="space-y-2">
              <button
                className="p-2 bg-black rounded-full text-white w-full font-semibold"
                onClick={closeModal}
              >
                Close
              </button>
